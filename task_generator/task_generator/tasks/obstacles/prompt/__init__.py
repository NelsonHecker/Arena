...
def declare_schema(node: ROSParamServer, ns: Namespace) -> None:
    ...
    declare_enum(node, ns("generation_mode"), "arena", choices=["arena", "behavior"], label="Generation mode", description="Generation mode: 'arena' generates waypoint-following agents, 'behavior' additionally generates arena_humansim agent-type behavior definitions.")
