...
from arena_rclpy_mixins.declarations import declare_bool, declare_double
...
from .schedule import DURATION_DEFAULTS, MODES
...
_DURATION_DESCRIPTIONS = {
    ...
    "ramp_horizon_s": "Time to interpolate from rest to a ramp's target speed.",
