...
# We import the bridge and tools to validate schemas
# These tests run without ROS (they only validate JSON Schema structure)


def _get_tools():
    """Lazy-import tools list."""
    # Don't import at module level — requires ROS packages
