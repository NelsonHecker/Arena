...
| `touch_world` | `touch_world <world_name> [--all] [--resolution N] [--assets color] ...` | Reads `world.yaml` and regenerates `map/map.png` + `map/map.yaml`; `--all` also rewrites `world.yaml` |
